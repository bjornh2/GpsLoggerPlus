...
class MicropyGPS(object):
    ...
    def __init__(self, local_offset=1, location_formatting='dd'):
        """
    ...
    def update_nmea_sentence(self, new_char_array):
        """Process an input char array and process it"""
        for x in range(len(new_char_array)):
            #print(chr(nmea_msg[x]))
            self.update(chr(new_char_array[x]))
                ...
                if valid_sentence:
                    ...
                    if self.gps_segments[0] in self.supported_sentences:
                        ...
                        if self.supported_sentences[self.gps_segments[0]](self):
                            self.last_nmea_type = self.gps_segments[0]
